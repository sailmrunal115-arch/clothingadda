...
if(isset($_GET['add'])) {
    ...
    header("Location: women.php"); exit();
}
...
<div class="filter-bar">
    <form method="GET" action="women.php" class="filter-form">
        ...
        <?php if(!empty($_GET['search']) || !empty($_GET['min_price']) || !empty($_GET['max_price'])): ?>
            <a href="women.php" class="clear-btn">Clear</a>
        <?php endif; ?>
    </form>
</div>
...
<?php if(isset($_SESSION['user_id'])): ?>
<a href="women.php?add=<?php echo $row['id']; ?>" class="btn cart-btn">Add to Cart</a>
<?php else: ?>
