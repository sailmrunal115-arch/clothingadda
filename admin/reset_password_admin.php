...
mysqli_query($conn,"UPDATE admins SET password='$password',reset_token=NULL WHERE reset_token='$token'");

echo "Password updated successfully! <a href='admin_login.php'>Login</a>";
